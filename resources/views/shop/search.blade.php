...
@section('title', 'S-Book | Kết quả tìm kiếm')
@section('content')

<div class="col-sm-9 padding-right">
	<div class="features_items"><!--features_items-->
		<h2 class="title text-center">Kết quả tìm kiếm của: {{$keywords}}</h2>
        @if(!isset($search_product[0])) <h4>Không kết quả nào từ Keyword: {{$keywords}}</h4>
        @else
		@foreach ($search_product as $product)
		<div class="col-sm-4">
			<a href="{{URL::to('/product-details/'.$product->pro_id)}}">
